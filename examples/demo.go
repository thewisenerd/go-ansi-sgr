...
func main() {
	...
	fmt.Println(d.Sprint("256-color-ciede2000", "ciede2000")) // optional CIEDE2000 (more _expensive_)
	...
	fmt.Println(d.Sprint("88-color-ciede2000", "ciede2000")) // optional CIEDE2000 (more _expensive_)

	d.Supports(colors.C16)                                   // 16-color mode
	fmt.Println(d.Sprint("16-color"))                        // default euclid (used if overrides not set)
	fmt.Println(d.Sprint("16-color-ciede2000", "ciede2000")) // optional CIEDE2000 (more _expensive_) (used if overrides not set)

	d.Supports(colors.C8)                                   // 8-color mode
	fmt.Println(d.Sprint("8-color"))                        // default euclid (used if overrides not set)
	fmt.Println(d.Sprint("8-color-ciede2000", "ciede2000")) // optional CIEDE2000 (more _expensive_) (used if overrides not set)

	fmt.Println(d.Color256.Print("256-color-direct"))                        // you can directly access the Print function of a color mode
	fmt.Println(d.Color256.Print("256-color-direct-ciede2000", "ciede2000")) // color difference algorithm can be passed too
